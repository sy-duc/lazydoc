...
MAX_TRANSLATION_INSTRUCTIONS_LENGTH = 300
...
class TranslateDialog(QDialog):
    ...
    def _setup_ui(self) -> None:
        ...
        self._instructions_edit = QLineEdit()
        ...
        self._instructions_edit.setMaxLength(
    ...
    def _toggle_expand(self) -> None:
        ...
        m = self._SHADOW_MARGIN * 2
        if expanded:
            target_height = max(720 + m, self.minimumSizeHint().height())
            self.setFixedHeight(target_height)
        else:
            self.setFixedHeight(720 + m)
    ...
    def _on_translate(self) -> None:
        ...
        config = {
            ...
            "translation_instructions": self._instructions_edit.text().strip(),
        }
